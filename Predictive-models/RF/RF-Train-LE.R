...
randomseed <- 1675#365#3890#1165#2030#
set.seed(randomseed)
...
# save model for later use
  save(RFmodel, file= paste(DataFolder,"/RFmodel_220604_13.Rdata", sep = ""))
...
# Save data to excel file
  ...
  writeData(ExcelFile, sheet = 3, capture.output(RFmodel))
  ...
  saveWorkbook(ExcelFile, paste(DataFolder,"/RF_output_220604_13.xlsx", sep = ""), overwrite = TRUE)
