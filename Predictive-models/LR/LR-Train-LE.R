...
save(LRmodel, file= paste(DataFolder,"/LRmodel.Rdata", sep = ""))
...
writeData(ExcelFile, sheet = 3, capture.output(LRmodel))
...
saveWorkbook(ExcelFile, paste(DataFolder,"/LR_output.xlsx", sep = ""), overwrite = TRUE)
